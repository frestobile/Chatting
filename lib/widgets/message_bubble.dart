          ...
          if (message.type != 'date')
            Container(
              ...
              decoration: BoxDecoration(
                color: message.sender != null && message.sender!.id == user.id
                    ? Colors.blue
                    : Colors.grey[300],
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          Text(reaction.emoji,
                              style: const TextStyle(
                                  fontFamily: 'NotoColorEmoji', fontSize: 14)),
                          const SizedBox(width: 8.0),
                          Text(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                              message
                                  .threadReplies[
                                      message.threadReplies.length - 1]
                                  .displayName,
                              style: TextStyle(
                          ...
                          Text('コメント  ${message.threadRepliesCount}件',
                              style: TextStyle(
                                  fontSize: 14, color: Colors.grey[400])),
                        ],
                      ),
